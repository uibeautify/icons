...
export function InfoSquare({
  ...
  return (
    <svg
      ...
      {...props}
    >
      <rect x="3" y="3" width="18" height="18" rx="3" strokeWidth={strokeWidth} stroke={color}/><path d="M12 16L12 12L10.5 12" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" stroke={color}/><path d="M12 8H12.0001" strokeWidth={strokeWidth} strokeLinecap="round" stroke={color}/>
    </svg>
  );
}
