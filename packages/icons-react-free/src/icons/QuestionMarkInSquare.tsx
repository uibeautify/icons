 ...
 */
export function QuestionMarkInSquare({
  size = 24,
  color = "currentColor",
  ...
  return (
    <svg
      ...
      {...props}
    >
      <rect x="3" y="3" width="18" height="18" rx="3" strokeWidth={strokeWidth} stroke={color}/><path d="M10 10C10 8.99157 10.9019 8 12 8C13.0981 8 14 8.99157 14 10C14 10.5284 13.7524 10.9345 13.3587 11.2014C12.7056 11.6441 12 12.211 12 13" strokeWidth={strokeWidth} strokeLinecap="round" strokeLinejoin="round" stroke={color}/><path d="M12 16H12.0001" strokeWidth={strokeWidth} strokeLinecap="round" stroke={color}/>
    </svg>
  );
}
